...
RHD$task_type[81:83] <- "constrained" # adding constrained to the constrained experiments within this study (the first one is free, and these three are constrained)
