...
```{r}
#load dataframe (for louise)
d <- as.data.frame(read_excel("C:/Users/louis/OneDrive - Aarhus universitet/AU Onedrive - RIGTIG/- 5. Semester/LNJ-ND/MetaLabPreprocess/Data/Matrix_MetaAnalysis_Diagnosis_updated290719.xlsx"))

#load dataframe (for nicole)
...
sz$TYPE_OF_TASK <- ifelse(sz$TYPE_OF_TASK == "constr", "constrained", sz$TYPE_OF_TASK)
...
feature <- c(rep("speech_duration", 5), #speech duration speech_duration
            ...
            rep("pitch_f5", 5),
            rep("pitch_f6", 5),
            rep("pitch_f0_variability", 5),
            rep("pitch_f0_entropy", 5),
            rep("pitch_f1_variability", 5),
            rep("pitch_f2_variability", 5),
            rep("pitch_bandwidth", 5),
            rep("pitch_f0_ran", 5), # only one value
            rep("intensity_mean", 5),
